...
p6 = ax1.scatter(nanx, nany, c="k", s=10, label="Unknown", alpha=1.0)
p1 = ax1.scatter(waterx, watery, c="#00c5ff", s=10, label="Waterline", alpha=1.0)
p2 = ax1.scatter(icex, icey, c="#00ff00", s=10, label="Ice-fall", alpha=1.0)
p3 = ax1.scatter(stackx, stacky, c="#e60000", s=10, label="Stack collapse", alpha=1.0)
p4 = ax1.scatter(sheetx, sheety, c="#ffaa00", s=10, label="Sheet collapse", alpha=1.0)
p5 = ax1.scatter(subx, suby, c="#8400a8", s=10, label="Subaqueous", alpha=1.0)


# Add legend to plot
ax1.legend(
    handles=[p2, p4, p3, p1, p5, p6, cloc],
